  ...
  render() {
    return (
      <div className="chapter3">
        <p>
          Chapter 3 starts with two options, either going to Sidecar Vinyl Record Store or Strawberry Fields record
          store.
        </p>
        <Key />
        <br />
        ...
        <p>
          If you chose Strawberry Fields record store as your first dialogue option choice, then you will be given the
          option to either return to Yard Sale Records or go to Sidecar Vinyl.
        </p>
        <br />
        <h3>Chapter 3 Sidecar Vinyl option</h3>
        <img className="chapter3-img" src={chapter3SidecarVinyl} alt="chapter3SidecarVinyl" />
        <p>
          If you chose Sidecar Vinyl record store as your first dialogue option choice, then you will be given the
          option to either return to Yard Sale Records or go to Strawberry Fields.
        </p>
        <br />
        <h3>Chapter 3 Yard Sale Records</h3>
        <img className="chapter3-img" src={chapter3YardSaleRecords} alt="chapter3YardSaleRecords" />
        <p>
          If you chose Yard Sale Records as your second option, you will be given the option to go visit the other
          record store that you did not choose as your first option. Or you can choose to stay at Yard Sale Records.
        </p>
        <br />
        ...
        <p>
          If you chose to visit Sidecar Vinyl and chose the options that led Didier to give you his number, the
          following two options become available, otherwise you will move onto the next chapter.
        </p>
        <img className="chapter3-img" src={chapter3SidecarOptions} alt="chapter3SidecarOptions" />
        <p>
          If you choose to call Didier, or you gave the name of your hotel to Didier in the Sidecar Vinyl dialogue
          options, then the following options become available.
        </p>
        <img className="chapter3-img" src={chapter3Eddie} alt="chapter2Eddie" />
        <br />
        <Link to="/Chapter2" className="previous-page-button">
          Chapter 2
        </Link>
        <Link to="/Chapter4" className="next-page-button">
          Chapter 4
        </Link>
        <br />
      </div>
